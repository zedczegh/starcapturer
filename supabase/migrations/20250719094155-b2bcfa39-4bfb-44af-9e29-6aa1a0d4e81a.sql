-- Add administrator role to existing roles enum (if it doesn't exist)
-- First check current user_roles table structure and add admin functionality
...
-- Update existing admin role or create if doesn't exist
INSERT INTO public.user_roles (user_id, role) 
SELECT id, 'admin' FROM auth.users 
WHERE email = 'admin@starcapturer.com'
