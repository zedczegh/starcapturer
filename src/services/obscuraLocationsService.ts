...
const atlasObscuraLocations: SharedAstroSpot[] = [
  ...
  {
    id: 'chandra-telescope',
    name: 'Chandra Space Telescope Ground Station',
    chineseName: '钱德拉太空望远镜地面站',
    latitude: 36.0000,
    longitude: -106.0000,
    isDarkSkyReserve: false,
    certification: 'Atlas Obscura',
  ...
  {
    id: 'montsec',
    name: 'Montsec Astronomy Park',
    chineseName: '蒙特塞克天文公园',
    latitude: 42.0500,
    longitude: 0.7333,
    isDarkSkyReserve: false,
    certification: 'Atlas Obscura',
