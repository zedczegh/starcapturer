 ...
 */
export function getWesternCitiesDatabase(): Record<string, Location & { chineseName?: string }> {
  return {
    "california": {
      name: "California, USA",
      latitude: 36.7783,
    ...
    "mont megantic": {
      ...
      chineseName: "蒙特-梅格丹特暗夜天空保护区，加拿大",
      latitude: 45.4568,
      longitude: -71.1524,
      placeDetails: "Dark Sky Reserve - International Dark Sky Association"
    },
    "natural bridges": {
      ...
      chineseName: "自然桥梁国家纪念碑暗夜天空公园，美国",
      latitude: 37.6124,
      longitude: -109.9847,
    ...
    "iriomote ishigaki": {
      ...
      chineseName: "西表石垣国家公园国际暗夜天空保护区，日本",
      latitude: 24.3423,
      longitude: 124.1546,
      placeDetails: "Dark Sky Reserve - International Dark Sky Association"
    },
