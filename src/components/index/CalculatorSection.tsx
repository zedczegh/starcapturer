...
const CalculatorSection: React.FC<CalculatorSectionProps> = ({ 
  ...
  return (
    <section 
      id="calculator" 
      className="py-16 px-4 md:px-8 min-h-[calc(100vh-5rem)] flex flex-col justify-center bg-gradient-to-b from-cosmic-900 to-cosmic-950 relative overflow-hidden"
    >
      {/* Decorative elements */}
