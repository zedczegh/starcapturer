                      ...
                      <div className="mt-3 pt-3 border-t border-blue-500/20 space-y-3">
                        ...
                        <div className="p-2 bg-cosmic-900/50 rounded border border-cosmic-700/30 space-y-1">
                          <div className="flex justify-between text-[10px]">
                            ...
                            <span id="parallax-result-parallel" className="text-amber-300 font-mono font-semibold">0px</span>
                          </div>
                          <div className="flex justify-between text-[10px]">
                            <span className="text-cosmic-400">{t('Parallax Angle:', '视差角：')}</span>
                            <span id="arcsec-result-parallel" className="text-blue-300 font-mono">0.0000"</span>
                          </div>
                          <div className="flex justify-between text-[10px]">
                            <span className="text-cosmic-400">{t('Distance:', '距离：')}</span>
                            <span id="parsec-info-parallel" className="text-green-300 font-mono">0.00 pc</span>
                          </div>
                        </div>
