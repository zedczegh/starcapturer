...
import { CalendarClock, MapPin, Star, Award, Building, Globe, Moon, TreePine } from "lucide-react";
...
const LocationCard: React.FC<LocationCardProps> = ({
  ...
  const getCertificationIcon = () => {
    ...
    if (certLower.includes('sanctuary')) {
      ...
      return <TreePine className="h-3.5 w-3.5 text-blue-400" fill="rgba(96, 165, 250, 0.3)" />;
