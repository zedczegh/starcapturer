...
const MapSelector: React.FC<MapSelectorProps> = ({
  ...
  return (
    <div className="relative w-full" ref={containerRef}>
      ...
      {showResults && (
        <div className="fixed md:absolute z-[100] mt-1 w-[calc(100vw-2rem)] md:w-full left-4 md:left-0 rounded-md bg-background border-2 border-primary/30 shadow-lg shadow-primary/20 overflow-hidden">
          <SearchResults 
            searchResults={searchResults} 
            handleSelectLocation={handleSelectLocation} 
            searchTerm={searchTerm} 
