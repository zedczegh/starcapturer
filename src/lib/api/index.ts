...
import * as pollutionApi from './pollution';
import * as astroSpotsApi from './astroSpots';
import * as coordinatesApi from './coordinates';
import * as clearSkyRateApi from './clearSkyRate';
...
export { weatherApi, locationApi, forecastApi, pollutionApi, astroSpotsApi, coordinatesApi, clearSkyRateApi };
