      ...
      <div className="pt-20 md:pt-28 pb-20">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto">
            <motion.div 
              className="flex justify-center mb-20 mt-12"
              initial={{ opacity: 0, y: -10 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5 }}
            >
              <Tabs defaultValue="about" className="w-full max-w-2xl">
                <TabsList className="grid grid-cols-3 mb-8 p-2">
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <TabsTrigger 
                      value="about" 
                      className="data-[state=active]:bg-primary/20 text-lg py-4 px-6 transition-all duration-300 hover:bg-cosmic-700/50"
                    >
